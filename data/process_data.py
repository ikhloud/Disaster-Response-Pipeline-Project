...
def load_data(messages_filepath, categories_filepath):
    ...
    '''
    Loads the data from csv files and Merge the two dataframe
    input:
...
def clean_data(df):
    '''
    clean data and dropping duplicates
    input:
...
def save_data(df, database_filename):
    ...
    '''
    Save clean df into sqlite database
    ...
    Output: 
         None. 
         The function saves the database in an sql file
    '''
